package com.comparer.sendemailservice.configuration;
...
import com.comparer.sendemailservice.properties.RabbitMQProperties;
...
public class AMQPConfig {
    ...
    @Bean
    MessageListenerAdapter listenerAdapter(EmailConsumerService listener) {
